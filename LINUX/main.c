...
#include <stdbool.h>
#include <math.h>
#include <unistd.h>                                                          // Libreria usada para el Sleep ELIMINAR SI SE USA EN LINUX. SUSTINUIR "Sleep(3000);" por "sleep(3);"
      ...
      case 1:
        ...
        for(;;)                                                                 // Ciclo for infinito para el menu de la sala convencional
        {
          ...
          else
          {
              ...
              sleep(3);                                                      // Espera 3 segundos. !!!!!!!!!!!!!!!!! REMPLAZAR POR "sleep(3);" si se usa un sistema con POSIX !!!!!!!!!!!
